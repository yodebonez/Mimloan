...
//			_service = new LoanApplicationService(_context, new Mock<ILogger<LoanApplicationService>>().Object);
//		}
...
//		{
//			var loan = new LoanApplication { ApplicantName = "John Doe", LoanAmount = 5000, LoanTerm = 12, InterestRate = 5 };
